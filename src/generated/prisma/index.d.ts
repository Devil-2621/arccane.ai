...
export namespace Prisma {
  ...
  */
  ...
  export type FragmentOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "messageId" | "content" | "sandboxUrl" | "titles" | "files" | "createdAt" | "updatedAt", ExtArgs["result"]["fragment"]>
  ...
  interface FragmentFieldRefs {
    ...
    readonly titles: FieldRef<"Fragment", 'String'>
  ...
  export type FragmentWhereInput = {
    ...
    titles?: StringFilter<"Fragment"> | string
  ...
  export type FragmentScalarWhereWithAggregatesInput = {
    ...
    titles?: StringWithAggregatesFilter<"Fragment"> | string
