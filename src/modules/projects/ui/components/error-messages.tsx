...
const messageRecoverySuggestions = [
  "Try refreshing the message feed to rebuild the conversation thread.",
  "Verify your connection and that the project agent is still running.",
  "If you keep seeing this, send the reference code to the team for support.",
];
      ...
      <main className="relative z-10 flex flex-1 items-center justify-center px-4 py-12 sm:px-6">
        ...
        >
          ...
          <p className="mt-6 text-base leading-relaxed text-muted-foreground">
            The assistant’s conversation history hit a snag. Your prior messages
            are preserved, so feel free to retry or revisit the dashboard while
            we steady the connection.
          </p>

          <ul className="mt-6 flex flex-col gap-3 text-sm leading-6 text-muted-foreground/90">
            {messageRecoverySuggestions.map((tip) => (
              <li
                key={tip}
